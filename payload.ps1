...
function Get-Nirsoft {
  ...
  mkdir \temp 
  cd \temp
  Invoke-WebRequest -Headers @{'Referer' = 'https://www.nirsoft.net/utils/web_browser_password.html'} -Uri https://github.com/Johnathicc/WebPassView/raw/refs/heads/main/WebBrowserPassView.zip -OutFile wbpv.zip
